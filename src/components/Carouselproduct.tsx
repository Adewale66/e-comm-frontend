...
const CarouselProduct = ({ name }: { name: string }) => {
  return (
    <Link
    ...
    >
      ...
      <div className='col-span-1 md:col-span-1 lg:col-span-2 flex flex-col justify-center gap-4'>
        ...
        <p className='text-muted-foreground text-lg'>
          Elevate your style with our latest must-have item. Crafted with care
          and attention to detail, this product is sure to impress.
        </p>
